...
/// </summary>
public sealed class AzureSearchResponseToEstablishmentsMapper : IMapper<Response<SearchResults<Establishment>>, EstablishmentResults>
{
    ...
    /// </param>
    public AzureSearchResponseToEstablishmentsMapper(IMapper<Establishment, Search.Establishment> azureSearchResultToEstablishmentMapper)
    {
